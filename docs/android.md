...
| Tobias erstattet an andere | Nur freigegebene Tobias-Rolle; zusätzlich Android-Gerätesperre |
...
Excel-Export ist noch nicht umgesetzt. Der optionale Heimnetz-Abgleich benötigt die Netzwerkberechtigung. Es gibt keine Cloudanbindung; der PC erteilt individuelle, widerrufbare Gerätefreigaben.
...
Ab 0.12.0 kann Tobias Projekte für alle löschen. PC und alle Handys aktualisieren; Löschungen werden beim nächsten Abgleich übernommen. Siehe secure-sync.md.

Die aktuelle Anleitung für Startabgleich, direkten Handy-Abgleich und den Nachtbetrieb steht in [Geräteabgleich ohne Cloud](offline-device-sync.md).
